<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="aluno.bepiducb.com.br.Login" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <h2>Dúvidas</h2>
            <p>
                Sistema de alunos(as) do BEPiD. <br />
                Apenas alunos(as) autorizados podem entrar.
