        ...
        protected void txtEnviar_Click(object sender, EventArgs e)
        {
            try
            {
                if (Page.IsValid)
                {
                    ...
                    SendEmail(_emails, "Dúvida do site www.bepiducb.com.br", "<img src='http://www.bepiducb.com.br/img/Untitled-2.png' width='150'/><br>Nome: " + txtNome.Text + "<Br>Email: " + txtEmail.Text + "<br>Descrição: " + txtDescricao.Text);
