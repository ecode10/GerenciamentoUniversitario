...
{
    public partial class UpdateAluno : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (Page.IsValid)
                {
                    if (BEPiD.Business.Util.Validacao.IsValidCPF(txtCPF.Text))
                    {
                        ...
                        dto.dataDeExpedicao = formataDataYYYYMMDD(txtDataExpedicao.Text);
                        ...
                        if (_brl.updateAluno(dto))
                        {
                            ...
                            Response.Redirect("UpdateAluno?Situacao=1");
                        }
                    }
                    else
                    {
