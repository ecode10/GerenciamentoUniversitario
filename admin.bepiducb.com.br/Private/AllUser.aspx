<%@ Page Title="" Language="C#" MasterPageFile="~/LogadoNovo.Master" AutoEventWireup="true" CodeBehind="AllUser.aspx.cs" Inherits="admin.bepiducb.com.br.Private.AllUser" %>
    ...
    <div class="row">
        ...
        <table style="width:70%;">
            <tr>
                ...
                <td style="width: 225px">
                    Tipo Aluno: 
                    <asp:DropDownList ID="cmbTipoAluno" CssClass="form-control"  runat="server" Width="171px">
                ...
                <asp:GridView runat="server" Width="100%" ID="grdAluno" GridLines="None" 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Foto">
                            <ItemTemplate>
                                <img src='http://s3.amazonaws.com/BEPiD/<%# Eval("Foto") %>' style='border-radius:20px; width:70px;'/>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="Numero" HeaderText="Kit" ItemStyle-Width="40" ItemStyle-HorizontalAlign="Center" />
