<%@ Page Title="" Language="C#" MasterPageFile="~/Adm.Master" AutoEventWireup="true" CodeBehind="DetailUser.aspx.cs" Inherits="BEPiD.Private.DetailUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                Data Expedição: <%#Eval("DataExpedicaoIdentidade") %><br />
                                Data de nascimento: <%#Eval("DataNascimento") %><br />
            ...
            <br /><p align="center">
                    <asp:Button Text="Voltar" runat="server" class="btn btn-primary btn-large" id="cmdVoltar" OnClick="cmdVoltar_Click" />
                 </p>
        </div>
        <%--<div class="col-md-4">
            <h3>Acesso</h3>
