...
namespace BEPiD.Private
{
    public partial class InscricoesExcel : System.Web.UI.Page
    {
        ...
        private void geraExcel()
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=InscricoesBEPiD-2015-1.xls");
        ...
        protected void imgButtonExcel_Click(object sender, ImageClickEventArgs e)
        {
            geraExcel();
        }
    }
